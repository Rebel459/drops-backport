package net.rebel459.drops_backport.worldgen.feature.speleothem;
...
public class SpeleothemUtils {
    ...
    private static BlockState createPointedBlock(final Direction direction, final SpeleothemThickness thickness, final Block pointedBlock) {
        return pointedBlock.defaultBlockState().setValue(PointedDripstoneBlock.TIP_DIRECTION, direction)
                .setValue(DBBlockStateProperties.SPELEOTHEM_THICKNESS, thickness);
    }
