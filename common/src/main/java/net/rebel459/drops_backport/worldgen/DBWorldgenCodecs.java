package net.rebel459.drops_backport.worldgen;
...
import net.rebel459.drops_backport.worldgen.feature.OffsetPlacement;
import net.rebel459.drops_backport.worldgen.feature.SequenceFeature;
import net.rebel459.drops_backport.worldgen.feature.TemplateFeature;
import net.rebel459.drops_backport.worldgen.feature.WeightedRandomSelectorFeature;
import net.rebel459.drops_backport.worldgen.feature.poplar.PoplarFoliagePlacer;
import net.rebel459.drops_backport.worldgen.feature.poplar.PoplarTrunkPlacer;
import net.rebel459.drops_backport.worldgen.feature.poplar.ShelfMushroomDecorator;
import net.rebel459.drops_backport.worldgen.feature.speleothem.SpeleothemClusterFeature;
import net.rebel459.drops_backport.worldgen.feature.speleothem.SpeleothemFeature;
...
public final class DBWorldgenCodecs {
    private static final UnifiedRegistries.DeferredRegistry<Feature<?>> FEATURES =
            UnifiedRegistries.DeferredRegistry.create(DropsBackport.VANILLA_ID, BuiltInRegistries.FEATURE);
    private static final UnifiedRegistries.DeferredRegistry<TrunkPlacerType<?>> TRUNK_PLACER_TYPES =
            UnifiedRegistries.DeferredRegistry.create(DropsBackport.VANILLA_ID, BuiltInRegistries.TRUNK_PLACER_TYPE);
    private static final UnifiedRegistries.DeferredRegistry<FoliagePlacerType<?>> FOLIAGE_PLACER_TYPES =
            UnifiedRegistries.DeferredRegistry.create(DropsBackport.VANILLA_ID, BuiltInRegistries.FOLIAGE_PLACER_TYPE);
    private static final UnifiedRegistries.DeferredRegistry<TreeDecoratorType<?>> TREE_DECORATOR_TYPES =
            UnifiedRegistries.DeferredRegistry.create(DropsBackport.VANILLA_ID, BuiltInRegistries.TREE_DECORATOR_TYPE);
    private static final UnifiedRegistries.DeferredRegistry<PlacementModifierType<?>> PLACEMENT_MODIFIER_TYPES =
            UnifiedRegistries.DeferredRegistry.create(DropsBackport.VANILLA_ID, BuiltInRegistries.PLACEMENT_MODIFIER_TYPE);
