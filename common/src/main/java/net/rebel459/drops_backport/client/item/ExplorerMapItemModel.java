package net.rebel459.drops_backport.client.item;
...
import net.rebel459.drops_backport.registry.DBMapDecorationTypes;
...
public class ExplorerMapItemModel implements ItemModel {
    private static final Identifier FILLED_MAP_MODEL = DropsBackport.vanillaId("item/filled_map");
    private static final Identifier EXPLORER_MAP_MODEL = DropsBackport.vanillaId("item/explorer_map");
    ...
    public static final Identifier TYPE = DropsBackport.modId("explorer_map");
    ...
    public static void init() {
        registerDecorationModel(DBMapDecorationTypes.ANCIENT_CITY, DropsBackport.vanillaId("ancient_city_map"));
        ...
        registerDecorationModel(MapDecorationTypes.OCEAN_MONUMENT, DropsBackport.vanillaId("ocean_monument_map"));
        registerDecorationModel(MapDecorationTypes.PLAINS_VILLAGE, DropsBackport.vanillaId("plains_village_map"));
        registerDecorationModel(MapDecorationTypes.SAVANNA_VILLAGE, DropsBackport.vanillaId("savanna_village_map"));
        registerDecorationModel(MapDecorationTypes.SNOWY_VILLAGE, DropsBackport.vanillaId("snowy_village_map"));
        registerDecorationModel(MapDecorationTypes.SWAMP_HUT, DropsBackport.vanillaId("swamp_hut_map"));
        registerDecorationModel(MapDecorationTypes.TAIGA_VILLAGE, DropsBackport.vanillaId("taiga_village_map"));
        registerDecorationModel(MapDecorationTypes.TRIAL_CHAMBERS, DropsBackport.vanillaId("trial_chamber_map"));
        registerDecorationModel(MapDecorationTypes.WOODLAND_MANSION, DropsBackport.vanillaId("woodland_mansion_map"));
    }
