package net.rebel459.drops_backport.sound;
...
public final class DBSoundEvents {
    private static final UnifiedRegistries.SoundEvents SOUNDS = UnifiedRegistries.SoundEvents.create(DropsBackport.VANILLA_ID);
