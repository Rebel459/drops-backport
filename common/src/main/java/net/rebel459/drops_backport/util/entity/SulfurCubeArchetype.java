...
public record SulfurCubeArchetype(Identifier id, TagKey<Item> items, float speed, float bounce, float friction, float airDrag, boolean buoyant, Optional<ExplosionData> explosion, Optional<ContactDamage> contactDamage, KnockbackModifiers knockbackModifiers, SoundSettings soundSettings) {
    ...
    public static SulfurCubeArchetype register(Identifier id, float speed, float bounce, float friction, float airDrag, boolean buoyant, Optional<ExplosionData> explosion, Optional<ContactDamage> contactDamage, KnockbackModifiers knockbackModifiers, SoundSettings soundSettings) {
        SulfurCubeArchetype archetype = new SulfurCubeArchetype(
                id,
                TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(id.getNamespace(), "sulfur_cube_archetype/" + id.getPath())),
                speed,
                bounce,
                friction,
                airDrag,
