package net.rebel459.drops_backported.client.particle.geyser;
...
import net.rebel459.drops_backported.particle.GeyserBaseParticleOptions;
...
public class GeyserEruptionParticle extends NoRenderParticle {
   ...
   protected GeyserEruptionParticle(
      ...
      this.lifetime = 20;
      this.plumeParticle = new GeyserParticleOptions(DBParticleTypes.GEYSER_PLUME.get(), this.waterBlocks);
      this.baseParticle = new GeyserBaseParticleOptions(DBParticleTypes.GEYSER_BASE.get(), this.waterBlocks, 1.5F);
      this.poofParticle = new GeyserBaseParticleOptions(DBParticleTypes.GEYSER_POOF.get(), this.waterBlocks, 2.0F);
   }
