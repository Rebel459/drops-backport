package net.rebel459.drops_backported.particle;
...
public record GeyserBaseParticleOptions(ParticleType<GeyserBaseParticleOptions> type, int waterBlocks,
                                        float burstImpulseBase) implements ParticleOptions {
